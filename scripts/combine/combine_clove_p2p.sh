...
combinedat=/exports/igmm/eddie/EyeMalform/X00013WK/sv/combined_sv
clovedat=/exports/igmm/eddie/EyeMalform/X00013WK/sv/clove
cd $tmpdir
combinepe=$combinedat/$id/lumpy_manta_calls.bedpe
clovepe=$clovedat/$id/$id.clove.bedpe
...
pairToPair -type both -is -slop $slop \
	-a $clovepe \
	-b $combinepe > both.bedpe

python $scriptdir/merge_pairToPair.py both.bedpe > CLM_both.bedpe	
