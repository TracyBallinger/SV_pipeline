...
DESTINATION=/exports/igmm/eddie/EyeMalform/X00013WK/2016-04-19_vcfs

# Do the copy with lftp without password assuming ssh keys have been setup on DataStore
#only with sepcific filetype
lftp -u $USER,NONE -p 22222 sftp://sg.datastore.ed.ac.uk  -e ' mirror -i "\.(.bam?)$" -c -v -P2 --no-perms /igmm/datastore/EyeMalform/X00013WK/X00013WK/2016-04-19 /exports/igmm/eddie/EyeMalform/X00013WK/2016-04-19; exit' 
